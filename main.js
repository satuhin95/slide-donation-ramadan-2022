...
function draggedResult(e, t) {
    t < 80 && (t = 80), 
    t > 180 && (t = 180),
     (dust_img.style.clipPath = `polygon(0px 0, 100% 0, 100% 100%, 0px 100%);`),
     // (dust_img.style.clipPath = `polygon(${t + 130}px 0, 100% 0, 100% 100%, ${t + 130}px 100%)`),
      (e.style.left = t + "px");
      let data = t - 80;
      pp_box_2.style = `opacity:${.0 + (data/100)}`;
...
function slide_2_show() {
    pp_box_1.classList ? pp_box_1.classList.add("hidden") : (pp_box_1.className += " hidden");
        ...
        // setTimeout(function () {
        //     box_2_text.classList ? box_2_text.classList.add("leftAnimi") : (box_2_text.className += " leftAnimi");
        // }, 100)
